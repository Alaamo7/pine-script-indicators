# تقرير اختبار TradingView — Swing Trader Template - Smart EGX v2 4

- **المعرّف:** 047
- **النوع:** Indicator
- **Pine Script:** v6
- **ملف المصدر:** `tradingview-export/2026-08-21/indicators/047-swing-trader-template-smart-egx-v2-4.pine`
...
- ترقية المصدر إلى Pine v6، وتصحيح وسائط `label` ونص الدليل، وإعادة استخدام عنصر واحد على آخر شمعة.
